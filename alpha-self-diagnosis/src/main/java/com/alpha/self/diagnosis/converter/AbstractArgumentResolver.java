...
/**
 * Created by xc.xiong on 2017/9/25.
 */
public abstract class AbstractArgumentResolver extends AbstractMessageConverterMethodProcessor implements HandlerMethodArgumentResolver {
     ...
     */
    public AbstractArgumentResolver(ConfigurableBeanFactory beanFactory) {
        super(null);
        this.configurableBeanFactory = beanFactory;
        this.expressionContext = (beanFactory != null ? new BeanExpressionContext(beanFactory, new org.springframework.web.context.request.RequestScope()) : null);
    }
     ...
     */
    public AbstractArgumentResolver(List<HttpMessageConverter<?>> converters) {
        super(converters);
    }
