package com.alpha.commons.core.sms;
...
public class SMSmessageClient {
    ...
    public static int sendSMS(String phoneNumber, String contentVar) {
        ...
        try {
            ...
            String url = StringUtil.replaceBrace(baseURL, phoneNumber, contentVar);
    ...
    public static int getCodeByBaidu(String content) {
        try {
            if (!StringUtils.isNotBlank(content)) {
                ...
                if (code == 1000) {
                    int submitStatus = jsonObject.getJSONObject("date").getIntValue("submitStatus");
