...
public class AesMrg {
    ...
    private static AesMrg aesMrg;

    private AesMrg() {

    }

    public static AesMrg getInstance(String key) {
        if (null != aesMrg) {
            return aesMrg;
        } else {
            keyBytes = key;
    ...
    public static void main(String[] args) {
        String content = "";
        String pStr = AesMrg.getInstance("hdxOkwoeyd89698o").encode(content);
        System.out.println("加密前：" + content);
        System.out.println("加密后:" + pStr);
//                  2a2d55fd40eb4d7b929ee0afec1226bf
        String a = "1e2aa0fe19da4ddba04b79d3b8384f39";
        String postStr = AesMrg.getInstance("hdxOkwoeyd89698o").decode(a);
