...
@Entity
@Table(name = "diagnosis_suggest_physicalexam")
public class DiagnosisSuggestPhysicalexam implements Serializable {


    private static final long serialVersionUID = 4398518397660243429L;
    /**
     * id
     */
    @Column(name = "id")
