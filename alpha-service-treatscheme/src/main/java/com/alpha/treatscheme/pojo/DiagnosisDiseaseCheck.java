...
@Entity
@Table(name = "diagnosis_disease_check")
public class DiagnosisDiseaseCheck implements Serializable {


    private static final long serialVersionUID = 8321792506814860675L;
    /**
     * id
     */
    @Column(name = "id")
