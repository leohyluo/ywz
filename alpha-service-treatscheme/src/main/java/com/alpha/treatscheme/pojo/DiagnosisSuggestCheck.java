...
@Entity
@Table(name = "diagnosis_suggest_check")
public class DiagnosisSuggestCheck implements Serializable {


    private static final long serialVersionUID = -6123340759972796204L;
    /**
     * id
     */
    @Column(name = "id")
